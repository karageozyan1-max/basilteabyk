...
    <FooterItem label="Shop" href="/shop" style={{ fontWeight: '800', fontSize: 20, color: GREEN }} />
    <FooterItem label="FAQs" href="/faq" style={{ fontWeight: '800', fontSize: 20, color: GREEN }} />
    <FooterItem label="Our Story" href="/story" style={{ fontWeight: '800', fontSize: 20, color: GREEN }} />
    <FooterItem label="Contact" href="/contact" style={{ fontWeight: '800', fontSize: 20, color: GREEN }} />
  </View>
</View>
      </SafeAreaView>
    </CartProvider>
